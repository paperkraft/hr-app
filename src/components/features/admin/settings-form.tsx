        ...
        <div className="flex flex-col gap-6">
            <Tabs defaultValue="general" className="w-full">
                <TabsList className="grid w-full grid-cols-4 mb-8 h-12 p-1 bg-muted/30">
                    <TabsTrigger value="general" className="flex items-center gap-2 text-sm font-medium">
                        <Clock className="size-4" /> Defaults
                    </TabsTrigger>
                    <TabsTrigger value="locations" className="flex items-center gap-2 text-sm font-medium">
                        <Globe className="size-4" /> Locations
                    </TabsTrigger>
                    <TabsTrigger value="attendance" className="flex items-center gap-2 text-sm font-medium">
                        <ShieldAlert className="size-4" /> Policies
                    </TabsTrigger>
                    <TabsTrigger value="leave" className="flex items-center gap-2 text-sm font-medium">
                        <CalendarRange className="size-4" /> Leave
                    </TabsTrigger>
                </TabsList>
