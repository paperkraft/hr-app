  ...
  return (
    <Card className="col-span-1 md:col-span-2">
      ...
      <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="bg-muted/30 p-4 rounded-sm border border-border flex flex-col gap-1">
        ...
        <div className="bg-primary/5 p-4 rounded-sm border border-primary/20 flex flex-col gap-1 col-span-2 md:col-span-1">
