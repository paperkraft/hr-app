    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-background">
      ...
      <div className="hidden md:flex flex-col justify-between w-1/2 bg-primary/5 p-10 lg:p-16 border-r border-border/50">
        <div className="flex items-center gap-2 text-primary">
          ...
          <span className="font-bold text-2xl tracking-tight">Nexus HRMS</span>
        </div>
        ...
        <div className="text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} Nexus Enterprise Systems. All rights reserved.
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12 lg:p-16">
        ...
        <div className="absolute top-8 left-8 md:hidden flex items-center gap-2 text-primary">
          ...
          <span className="font-bold text-xl tracking-tight">Nexus HRMS</span>
        </div>
